...
public class UserRepositoryTest extends AdminStudyApplicationTests {
    ...
    public void create () {
        ...
        User userChainTest = new User().setAccount("박지연").setStatus(UserStatus.REGISTERED); // Lombok의 Chain을 활용한 인스턴스 생성
        userChainTest.setStatus(UserStatus.UNREGISTERED).setPhoneNumber("010-0000-0000"); // Lombok의 Chain을 활용한 인스턴스 수정
